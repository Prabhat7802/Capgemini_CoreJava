...
public class Assignment3Q4 {
	...
	public static void main(String[] args) {
		...
		DateClass date1 = new DateClass(15, 05, 2004);
		DateClass date2 = new DateClass(12, 03, 2002);
		DateClass date3 = new DateClass(15, 05, 2006);
		DateClass date4 = new DateClass(23, 04, 2005);
		
		HashMap<DateClass, String> dob = new HashMap<>();
		dob.put(date1, "John Dalton");
		dob.put(date2, "Anand Raj");
		dob.put(date3, "Dev Sharma");
		dob.put(date4, "Arun sharma");
		Assignment3Q4 obj = new Assignment3Q4();
		
		System.out.println(obj.getEmployee(dob, "Dev Sharma"));
		System.out.println(obj.getEmployee(dob, "John Dalton"));
		System.out.println(obj.getEmployee(dob, "Arun Sharma"));
	}
