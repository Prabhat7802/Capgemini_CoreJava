...
class Parked_CarOwnerList {
	...
	public void add_new_car(Assignment3Q7 obj) {
		...
		if (levelCount >= 3) {
			if (sectionCount >= 4) {
				if (slotsCount >= 20) {
					canPark = false;
					System.out.println("Sorry! You Cant park the car, Parking slots are full");
				} else {
					slotsCount++;
				}
			} else {
	...
	public String get_parked_car_location(int token) {
		String location = "You dont have any car parked";
...
public class Assignment3Q7 {
	...
	public static void main(String[] args) {
		...
		Assignment3Q7 obj1 = new Assignment3Q7("Aditya Sharma", "Skoda", 101, 928385492, "Bangalore");
		Assignment3Q7 obj2 = new Assignment3Q7("Abhijeet sharma", "Mahindra", 102, 638493929, "Delhi");
		Assignment3Q7 obj3 = new Assignment3Q7("Naman Jain", "Hyundai", 103, 627183934, "Indore");
		Assignment3Q7 obj4 = new Assignment3Q7("Satish Kumar", "Tata", 104, 622339984, "Noida");
